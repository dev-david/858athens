				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 856 & 858 Athens Ave? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 856 & 858 Athens Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3016 Adeline St - Duplex</strong></h3>
										<ul>
											<li>4 Bed - 1 Bath</li>
											<li>1 Bed - 1 Bath</li>
											<li>2,172 Sq Ft - 4,636 Lot</li>
											<li>List: 7/8/13 - Pending: 7/25/13</li>
											<li>List: $329,500 - SOLD $300,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>1242 28th - Duplex</strong></h3>
										<ul>
											<li>3 Bed - 1 Bath</li>
											<li>3 Bed - 1.5 Bath</li>
											<li>2,507 Sq Ft - 2,507 Lot</li>
											<li>List: 3/28/12 - Pending: 4/22/11</li>
											<li>List: $250,000 - SOLD $306,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>1016 32nd St - Duplex</strong></h3>
										<ul>
											<li>2 Bed - 2 Bath</li>
											<li>2 Bed - 1 Bath</li>
											<li>1,479 Sq Ft - 2,500 Lot</li>
											<li>List: 6/14/13 - Pending: 6/25/13</li>
											<li>List: $399,000 - SOLD $385,000</li>
										</ul>
									</article>
								</div>
							</div>
